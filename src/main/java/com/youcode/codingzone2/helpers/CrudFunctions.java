...
public class CrudFunctions {
    ...
    public static String getAllWhere(String tableName , String condition) {
    ...
    public static String getColumnFromTableWithCondtion (String tableName , String column , String condition) {
